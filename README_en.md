...
2. Click the "Exporter export.js" button.
3. Take the generated `export.js` file and replace the original file (usually `main.js`) in your project from [ps5-y2jb-autoloader](https://github.com/itsPLK/ps5-y2jb-autoloader).
